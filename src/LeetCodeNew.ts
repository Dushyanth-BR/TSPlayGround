...
export default class LeetCodeNew{
    ...
    public callFunction(): void{
        ...
        // isValid("([])");
        let list1: ListNode = new ListNode(1, new ListNode(2, new ListNode(4))); let list2: ListNode = new ListNode(1, new ListNode(3, new ListNode(4)));
